...
class Contact extends AppModel {
	...
	public $validate = array(
		...
		'filename' => array(
			...
			/*'extension' => array(
				'rule' => array('extension', array('csv','txt','php')),
				'message' => 'Invalid file, only csv allowed',
				'required' => FALSE,
				'allowEmpty' => FALSE,
			),*/
	...
	public function processUpload($check=array()) {
		...
		if (!empty($check['filename']['tmp_name'])) {
			...
			// build full filename
			$filename = $this-> uploadDir . DS . Inflector::slug(pathinfo($check['filename']['name'], PATHINFO_FILENAME)).'.'.pathinfo($check['filename']['name'], PATHINFO_EXTENSION);
//. Inflector::slug(pathinfo($check['filename']['name'], PATHINFO_FILENAME)).'.'.pathinfo($check['filename']['name'], PATHINFO_EXTENSION
		...
		return TRUE;
		$cases = $this->Contact->RjCase->find('list');
