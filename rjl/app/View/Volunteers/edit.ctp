...
jQuery.validator.addMethod("zipcodeonly", function(value, element) {return this.optional(element) || /^\d{5}(?:-\d{4})?$/.test(value);}, "Not a valid zip code");	
	...
	$("#evolForm").validate({ignore: ":hidden:not(select)"});
	...
	$( "#VolunteerDateOfBirth" ).rules( "add", {
		required: true,
		date: true
	});
...
echo $this->Form->create('Volunteer',array('id'=>'evolForm')); ?>

<legend>Edit Volunteer</legend>
<div class="row">
...
<div class="row">
	<div class="col-md-3 required">
		<?php echo $this->Form->input('dateOfBirth',array('type'=>'text','class'=>'evoldatepicker','readonly' =>'readonly')); ?>
	</div>
	<div class="col-md-3">
