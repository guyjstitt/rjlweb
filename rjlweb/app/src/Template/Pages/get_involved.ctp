...
<div class="row mainContainer page"> 
	<div id= "contentContainer" class = "col-md-8 center">
		<div class="col-md-8">
			...
			<h3 class="subHead">Proven impact on participants</h3>
			<p class="pageText">
			...
			<ul>
				<li>Significant cost savings for every case resolved outside the court system</li>
				<li>Restoration for victims</li>
				<li>Closure and healing for victims and their community</li>
				<li>Promotion and support of positive behavioral change of offenders</li>
				<li>Successful re-integration of the young offenders back into the community</li>
				<li>Prevention of future crime</li>
			</ul>
			<h3 class="subHead">RJL Case Examples</h3>
			<p class="pageText">
	...
	<script type="text/javascript" src="/rjlweb/app/webroot/js/ajax.js"></script>
</div>
