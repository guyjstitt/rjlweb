<div id="slider">
		<div class="slider1">
			<div class="slide gradient"><img src="http://www.spokesman-recorder.com/wp-content/uploads/2013/06/black-school-children1.jpg">
				<div class='slideContent'>
					<h4 class="slideHeader">These kids are learning from their mistakes</h4>
					<p class="slideMessage">At RJL, we turn bad kids into people that contribute to society</p>
					<div class="fb-share-button hide" data-href="https://developers.facebook.com/docs/plugins/" data-width="30px"></div>
					<div id="fb-root"></div>
		        </div>
			</div>
